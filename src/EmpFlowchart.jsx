...
const BASE_W = 1800; // Base width (px)
const BASE_H = 900;  // Base height (px)
...
const moveDotBLZig = keyframes({
  '0%': { top: '40.3%', left: 'calc(5% + 19%)' },
  '30%': { top: '40.3%', left: 'calc(55% + 1px)' },
  '70%': { top: '88%', left: 'calc(55% + 1px)' },
  '100%': { top: '88%', left: '80%' }
});
...
/* ====== EmpFlowchart ====== */
export default function EmpFlowchart({ args = {} }) {
  const {
