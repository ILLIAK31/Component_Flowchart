...
const wrapper = {
  ...
  /* TL картка */
  '& > .item.-type2.-tl > .circle': { marginTop: '5%', width: '35%', height: '25%', padding: '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', marginLeft: '-20%' },
  ...
  '& > .item.-type2.-tl > .circle .bigNum': { lineHeight: 1, fontWeight: 300, color: '#2b2b2b', fontSize: '48px', flexShrink: 0, marginLeft: '15%', fontVariantNumeric: 'tabular-nums', fontFeatureSettings: '"tnum"' },

  /* === TL STATS === */
  '& > .item.-type2.-tl > .stats': { position: 'absolute', left: '10%', top: 'calc(40% + 18%)', transform: 'translate(-50%, 0)', display: 'grid', rowGap: '10px', width: '34%', zIndex: 3, pointerEvents: 'none' },
  '& > .item.-type2.-tl > .stats .row': { display: 'inline-flex', gridTemplateColumns: 'auto max-content auto', alignItems: 'center', columnGap: '8px', lineHeight: 1.1 },
  '& > .item.-type2.-tl > .stats .row.-pair': { display: 'flex', alignItems: 'center', gap: '14px' },
  '& > .item.-type2.-tl > .stats .grp': { display: 'inline-flex', alignItems: 'center', gap: '8px' },
  '& > .item.-type2.-tl > .stats .ico': { height: '26px', width: 'auto' },
  '& > .item.-type2.-tl > .stats .val': { fontSize: '26px', color: '#fc4d57', fontWeight: 800, display: 'inline-block', fontVariantNumeric: 'tabular-nums', fontFeatureSettings: '"tnum"' },
  '& > .item.-type2.-tl > .stats .suffix': { fontWeight: 600, fontSize: '18px', color: '#9397a1' },

  /* === TR STATS === */
  '& > .item.-type2.-tr > .stats': { position: 'absolute', right: '90%', top: 'calc(40% + 18%)', transform: 'translate(50%, 0) scaleX(-1)', display: 'grid', rowGap: '10px', width: '34%', zIndex: 3, pointerEvents: 'none' },
  '& > .item.-type2.-tr > .stats .row': { display: 'inline-flex', alignItems: 'center', gap: '8px', whiteSpace: 'nowrap', lineHeight: 1.1 },
  '& > .item.-type2.-tr > .stats .ico, & > .item.-type2.-tr > .stats .val, & > .item.-type2.-tr > .stats .suffix': { flex: '0 0 auto' },
  '& > .item.-type2.-tr > .stats .ico': { height: '26px', width: 'auto' },
  '& > .item.-type2.-tr > .stats .val': { fontSize: '26px', color: '#fc4d57', fontWeight: 800, display: 'inline-block' },
  '& > .item.-type2.-tr > .stats .suffix': { fontWeight: 600, fontSize: '18px', color: '#9397a1' },

  /* === BL STATS === */
  '& > .item.-type2.-bl > .stats': { position: 'absolute', left: '10%', top: 'calc(-15% + 18%)', transform: 'translate(-50%, 0) scaleY(-1)', display: 'grid', rowGap: '10px', width: '34%', zIndex: 3, pointerEvents: 'none' },
  '& > .item.-type2.-bl > .stats .row': { display: 'flex', alignItems: 'center', columnGap: '8px', lineHeight: 1.1 },
  '& > .item.-type2.-bl > .stats .row.-pair': { display: 'flex', alignItems: 'center', gap: '14px' },
  '& > .item.-type2.-bl > .stats .grp': { display: 'inline-flex', alignItems: 'center', gap: '8px' },
  '& > .item.-type2.-bl > .stats .ico': { height: '26px', width: 'auto' },
  '& > .item.-type2.-bl > .stats .val': { fontSize: '26px', color: '#fc4d57', fontWeight: 800, display: 'inline-block' },
  '& > .item.-type2.-bl > .stats .suffix': { fontWeight: 600, fontSize: '18px', color: '#9397a1' },

  /* === BR STATS === */
  '& > .item.-type2.-br > .stats': { position: 'absolute', right: '90%', top: 'calc(-15% + 18%)', transform: 'translate(50%, 0) scaleX(-1) scaleY(-1)', display: 'grid', rowGap: '10px', width: '34%', zIndex: 3, pointerEvents: 'none' },
  '& > .item.-type2.-br > .stats .row': { display: 'inline-flex', alignItems: 'center', gap: '8px', whiteSpace: 'nowrap', lineHeight: 1.1 },
  '& > .item.-type2.-br > .stats .ico, & > .item.-type2.-br > .stats .val, & > .item.-type2.-br > .stats .suffix': { flex: '0 0 auto' },
  '& > .item.-type2.-br > .stats .ico': { height: '26px', width: 'auto' },
  '& > .item.-type2.-br > .stats .val': { fontSize: '26px', color: '#fc4d57', fontWeight: 800, display: 'inline-block' },
  '& > .item.-type2.-br > .stats .suffix': { fontWeight: 600, fontSize: '18px', color: '#9397a1' },

  /* Картки */
  '& > .item.-type2.-bl > .circle.-numCard, & > .item.-type2.-tr > .circle.-numCard, & > .item.-type2.-br > .circle.-numCard': {
    width: '35%', height: '25%', padding: '0 24px', display: 'inline-flex', alignItems: 'center', justifyContent: 'space-between',
  },
  ...
  '& > .item.-type2.-bl > .circle.-numCard .bigNum, & > .item.-type2.-tr > .circle.-numCard .bigNum, & > .item.-type2.-br > .circle.-numCard .bigNum': {
    lineHeight: 1, fontWeight: 300, color: '#2b2b2b', fontSize: '48px',
  },
  ...
  '& > .item.-bottom-main > .circle': { top: '28%', height: '25% !important', width: '35% !important' },
  ...
  /* ERP stats */
  '& > .erp-stats': { position: 'absolute', left: '61.5%', top: '88%', transform: 'translateX(-50%)', display: 'grid', rowGap: '8px', width: '40%', pointerEvents: 'none', zIndex: 10000 },
  '& > .erp-stats .row': { display: 'inline-flex', alignItems: 'baseline', gap: '8px', lineHeight: 1.1, whiteSpace: 'nowrap' },
  '& > .erp-stats .label': { fontWeight: 700, fontSize: '18px', color: '#9397a1', letterSpacing: '0.02em' },
  '& > .erp-stats .val': { fontSize: '26px', color: '#fc4d57', fontWeight: 800 },
  '& > .erp-stats .suffix': { fontWeight: 600, fontSize: '18px', color: '#9397a1' },
